        ...
        const channel = supabase
            ...
            .on(
                'postgres_changes',
                {
                    ...
                    schema: 'public',
                    table: 'notifications',
                    filter: `user_id=eq.${supabase.auth.getUser().then(({ data }) => data.user?.id)}` // This won't work directly in filter string for auth.uid
                    // Better to just listen to all and filter or refresh.
                    // For simplicity, just refresh on any insert to 'notifications'
                },
                () => {
                    fetchNotifications();
                }
        ...
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-slate-600">Stay updated with system alerts and activities</p>
                </div>
