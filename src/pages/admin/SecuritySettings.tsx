        ...
        <div className="space-y-6 max-w-6xl mx-auto p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                >
                    ...
                    {/* Hidden Modal logic via native dialog or state - using state is better but for quick logic we use a conditional render */}
                </motion.div>

                <dialog id="setup-2fa-modal" className="modal bg-transparent p-0 backdrop:bg-black/50 open:backdrop:bg-black/50 rounded-xl shadow-2xl">
                    <div className="bg-transparent">
                        <Setup2FA
                            onComplete={() => (document.getElementById('setup-2fa-modal') as any)?.close()}
                            onCancel={() => (document.getElementById('setup-2fa-modal') as any)?.close()}
                        />
                    </div>
                </dialog>
